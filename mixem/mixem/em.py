...
def em(data, distributions, initial_weights=None, max_iterations=1000, tol=1e-10, tol_iters=1, progress_callback=mixem.simple_progress):
	...
	#print resp
        ...
        iteration += 1
    #print "Iteration time of EM: " + str(time.time()-start) + " seconds"
    return weight, distributions, last_ll[0],iteration
